...
public class MathHelper {
    ...
    public static float sqrt_float(float value) {
        return XMathHelper.INSTANCE.squareRootFloat(value);
    }

    public static float sqrt_double(double value) {
        return (float) XMathHelper.INSTANCE.squareRootDouble(value);
    }

    public static int floor_float(float value) {
        return XMathHelper.INSTANCE.floorToInteger(value);
    }
    ...
    public static double atan2(double y, double x) {
        return XMathHelper.INSTANCE.atan2(y, x);
    }

    // useless code (?)
    public static double calculateInverseSine(double x) {
        double halfX = 0.5 * x;
   ...
   /*     int i = (int) (p_181758_0_ * 6.0F) % 6;
        ...
        return j << 16 | k << 8 | l;*/
        return XMathHelper.INSTANCE.convertHSVToRGB(h, s, v);
    }
