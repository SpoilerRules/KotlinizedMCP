...
import net.minecraft.util.XMathHelper;
...
public class MapGenCaves extends MapGenBase {
    ...
    protected void generateCave(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_) {
        ...
        for (boolean flag = random.nextInt(6) == 0; p_180702_15_ < p_180702_16_; ++p_180702_15_) {
            double d2 = 1.5D + (Math.sin((float) p_180702_15_ * (float) Math.PI / (float) p_180702_16_) * p_180702_12_ * 1.0F);
            double d3 = d2 * p_180702_17_;
            float f2 = XMathHelper.INSTANCE.cos(p_180702_14_);
            float f3 = XMathHelper.INSTANCE.sin(p_180702_14_);
            p_180702_6_ += XMathHelper.INSTANCE.cos(p_180702_13_) * f2;
            p_180702_8_ += f3;
            p_180702_10_ += XMathHelper.INSTANCE.sin(p_180702_13_) * f2;
            ...
            if (!flag2 && p_180702_15_ == j && p_180702_12_ > 1.0F && p_180702_16_ > 0) {
                this.generateCave(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, random.nextFloat() * 0.5F + 0.5F, p_180702_13_ - ((float) Math.PI / 2F), p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
                this.generateCave(random.nextLong(), p_180702_3_, p_180702_4_, p_180702_5_, p_180702_6_, p_180702_8_, p_180702_10_, random.nextFloat() * 0.5F + 0.5F, p_180702_13_ + ((float) Math.PI / 2F), p_180702_14_ / 3.0F, p_180702_15_, p_180702_16_, 1.0D);
                return;
            }
            ...
            if (flag2 || random.nextInt(4) != 0) {
                ...
                if (p_180702_6_ >= d0 - 16.0D - d2 * 2.0D && p_180702_10_ >= d1 - 16.0D - d2 * 2.0D && p_180702_6_ <= d0 + 16.0D + d2 * 2.0D && p_180702_10_ <= d1 + 16.0D + d2 * 2.0D) {
                    int k2 = XMathHelper.INSTANCE.floorToInteger(p_180702_6_ - d2) - p_180702_3_ * 16 - 1;
                    int k = XMathHelper.INSTANCE.floorToInteger(p_180702_6_ + d2) - p_180702_3_ * 16 + 1;
                    int l2 = XMathHelper.INSTANCE.floorToInteger(p_180702_8_ - d3) - 1;
                    int l = XMathHelper.INSTANCE.floorToInteger(p_180702_8_ + d3) + 1;
                    int i3 = XMathHelper.INSTANCE.floorToInteger(p_180702_10_ - d2) - p_180702_4_ * 16 - 1;
                    int i1 = XMathHelper.INSTANCE.floorToInteger(p_180702_10_ + d2) - p_180702_4_ * 16 + 1;
                                ...
                                if (d10 * d10 + d8 * d8 < 1.0D) {
                                    for (int j2 = l; j2 > l2; --j2) {
                                        ...
                                        if (d9 > -0.7D && d10 * d10 + d9 * d9 + d8 * d8 < 1.0D) {
                                            ...
                                            if (this.shouldReplaceBlock(iblockstate1, iblockstate2)) {
                                                if (j2 - 1 < 10) {
    ...
    protected boolean shouldReplaceBlock(IBlockState p_175793_1_, IBlockState p_175793_2_) {
