    ...
    private void drawActivePotionEffects()
    {
        ...
        if (!collection.isEmpty())
        {
            ...
            for (PotionEffect potioneffect : this.mc.thePlayer.getActivePotionEffects())
            {
                ...
                String s1 = LocalizationHelper.translate(potion.getName(), new Object[0]);

                if (potioneffect.getAmplifier() == 1)
                {
                    s1 = s1 + " " + LocalizationHelper.translate("enchantment.level.2", new Object[0]);
                }
                else if (potioneffect.getAmplifier() == 2)
                {
                    s1 = s1 + " " + LocalizationHelper.translate("enchantment.level.3", new Object[0]);
                }
