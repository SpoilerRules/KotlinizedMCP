...
public class WorldRenderer {
    ...
    public void putColorMultiplierRgba(float p_putColorMultiplierRgba_1_, float p_putColorMultiplierRgba_2_, float p_putColorMultiplierRgba_3_, float p_putColorMultiplierRgba_4_, int p_putColorMultiplierRgba_5_) {
        ...
        if (!this.noColor) {
            ...
            int[] rgba = new int[4];
            if (ByteOrder.nativeOrder() == ByteOrder.LITTLE_ENDIAN) {
                rgba[0] = (int) ((float) (j & 255) * p_putColorMultiplierRgba_1_);
                rgba[1] = (int) ((float) (j >> 8 & 255) * p_putColorMultiplierRgba_2_);
                rgba[2] = (int) ((float) (j >> 16 & 255) * p_putColorMultiplierRgba_3_);
                rgba[3] = (int) ((float) (j >> 24 & 255) * p_putColorMultiplierRgba_4_);
            } else {
                rgba[0] = (int) ((float) (j >> 24 & 255) * p_putColorMultiplierRgba_1_);
                rgba[1] = (int) ((float) (j >> 16 & 255) * p_putColorMultiplierRgba_2_);
                rgba[2] = (int) ((float) (j >> 8 & 255) * p_putColorMultiplierRgba_3_);
                rgba[3] = (int) ((float) (j & 255) * p_putColorMultiplierRgba_4_);
            }
            j = rgba[3] << 24 | rgba[2] << 16 | rgba[1] << 8 | rgba[0];
        }
