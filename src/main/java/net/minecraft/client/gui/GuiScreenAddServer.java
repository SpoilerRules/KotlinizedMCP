...
public class GuiScreenAddServer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, LocalizationHelper.translate("addServer.title", new Object[0]), this.width / 2, 17, 16777215);
        this.drawString(this.fontRendererObj, LocalizationHelper.translate("addServer.enterName", new Object[0]), this.width / 2 - 100, 53, 10526880);
        this.drawString(this.fontRendererObj, LocalizationHelper.translate("addServer.enterIp", new Object[0]), this.width / 2 - 100, 94, 10526880);
