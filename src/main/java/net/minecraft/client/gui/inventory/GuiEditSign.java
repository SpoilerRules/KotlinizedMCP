...
public class GuiEditSign extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.buttonList.add(this.doneBtn = new GuiButton(0, this.width / 2 - 100, this.height / 4 + 120, LocalizationHelper.translate("gui.done", new Object[0])));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObject, LocalizationHelper.translate("sign.edit", new Object[0]), this.width / 2, 40, 16777215);
