...
public abstract class GuiSlot {
    ...
    protected abstract boolean isElementSelected(int slotIndex);
    ...
    protected void setSelected(int p_178040_1_, int p_178040_2_, int p_178040_3_) {
    }
    ...
    public int getSlotIndexFromScreenCoords(int mouseX, int mouseY) {
        int listStart = this.left + this.width / 2 - this.getListWidth() / 2;
        int listEnd = this.left + this.width / 2 + this.getListWidth() / 2;
        int relativeY = mouseY - this.top - this.headerPadding + (int) this.amountScrolled - 4;
        int slotIndex = relativeY / this.slotHeight;

        if (mouseX < this.getScrollBarX() && mouseX >= listStart && mouseX <= listEnd && slotIndex >= 0 && relativeY >= 0 && slotIndex < this.getSize()) {
            return slotIndex;
        } else {
            return -1;
        }
    ...
    protected void drawSelectionBox(int p_148120_1_, int p_148120_2_, int mouseXIn, int mouseYIn) {
        ...
        for (int j = 0; j < i; ++j) {
            ...
            if (this.showSelectionBox && this.isElementSelected(j)) {
